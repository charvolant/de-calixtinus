...
COPY . /build/
RUN mkdir -p /app/lib && mkdir -p /app/bin && cp -r static config-static.yaml camino-portuguese.json camino-fisterra.json camino-frances.json camino-ingles.json /app/lib
